    ...
    <div class="container shadow bg-white radius-20 p-5 ">
        <div class="text-center ">
            ...
            <p class="text-center mt-3">
                We’re here to help you every step of the way! Whether you’re a first-time visitor interested in learning more about our solutions or an existing Savitar PMS user seeking support, we’ve got you covered.
            </p>
        </div>
            ...
            <div class="col-lg-4 bg-darkblue  contact-info p-4">
                ...
                <ul class="list-unstyled ">
                    ...
                    <li class="  ">
                        ...
                        <span class="">FF - 123, I Square, Science City Rd, nr. Shukan Mall, Crossroads, Sola, Ahmedabad, Gujarat 380060</span>
                    </li>
                ...
                <form action="insert.php" method="post">
                    <div class="row contact-form">
                        ...
                        <div class="col-12 form-group">
                            <div class="input-group">
                                <input type="text" name="property_name" placeholder="Property Name" class="form-control" required>
                                <span class="input-group-text bg-white">
                        ...
                        <div class="col-12 form-group">
                            <div class="input-group">
                                <textarea class="form-control" name="message" placeholder="Your Message" rows="2" required></textarea>
                                <span class="input-group-text bg-white">
