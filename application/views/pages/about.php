        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 p-4 align-content-center">
                    ...
                    <h4>Welcome to Savitar PMS! We are dedicated to providing one of the best hotel property management systems in the USA. Our innovative, cloud-based software is designed to streamline your hotel’s operations, enhance guest experiences, and boost profitability.</h4>
                </div>
            </div>
        </div>
    </section>
