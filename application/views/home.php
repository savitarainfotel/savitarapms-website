...
<main>
    ...
    <section class="banner_area bg-image">
        <div class="container py-5">
            <div class="row pt-lg-5 px-5 g-3 reverse">
    ...
    <div id="background" class="container-fluid ">
        ...
        <section class="my-5 py-5 ">
            <div class="container bg-darkblue radius-20 ">
            ...
            <div class="container pb-5">
                ...
                <div class="row mt-3 p-5 bg-darkblue radius-20 ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12  text-white" style="padding-left: 8%;">
                        <ul class="">
                            <li >
                                <p class="text-white">Access Management</p>
                            </li>
                            <li><p class="text-white">Revenue Management</p></li>
                            <li><p class="text-white">Point of Sale</p></li>
                            <li><p class="text-white">CRS & Channel Managers</p></li>
                            <li><p class="text-white">Accounting Systems</p></li>
                            <li><p class="text-white">Government Compliance</p></li>
                        </ul>
                    </div>
                </div>
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 ">
                        <div class="bg-white radius-20 p-5 h-100">
                            ...
                            <?= anchor('contact-us', 'Explore market place', 'class="btn-blue"'); ?>                            
