(function ($) {
	...
	function submitForm(){
		...
		const data = new FormData(document.getElementById($contactform.attr('id')));
		const submitBtn = $contactform.find('[type="submit"]');
		...
		$.ajax({
            ...
            error: function(jqXHR) {
				submitMSG(false, ajax_error_message_rsp(jqXHR));
            },
            success: function(result) {
				submitMSG(!result.error, result.message);
            },
            complete: function() {
                setTimeout(() => {
